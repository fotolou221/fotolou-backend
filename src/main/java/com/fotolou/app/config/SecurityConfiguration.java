        ...
        http.cors(withDefaults())
            ...
            .authorizeHttpRequests(authz ->
                authz
                    ...
                    .permitAll()
                    // Boutique : lecture publique, écriture réservée à l'administration
                    ...
                    .hasAuthority(AuthoritiesConstants.ADMIN)
                    // Fichiers : lecture publique, téléversement réservé aux comptes authentifiés
                    ...
                    .permitAll()
                    // Commandes boutique : le client passe / confirme sa commande, le reste est réservé à l'admin
                    ...
                    .permitAll()
                    .requestMatchers("/api/orders", "/api/orders/**", "/api/boutique-orders", "/api/boutique-orders/**")
                    .hasAuthority(AuthoritiesConstants.ADMIN)
